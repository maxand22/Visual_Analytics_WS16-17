...
# Generated by qmake (2.01a) (Qt 4.8.7) on: So. Dez 11 11:22:23 2016
# Project:  cfgtest_QtDesigner.pro
# Template: app
# Command: /usr/local/Cellar/qt/4.8.7_2/bin/qmake -spec /usr/local/Cellar/qt/4.8.7_2/mkspecs/macx-g++ -o cfgtest_QtDesigner.mk cfgtest_QtDesigner.pro
#############################################################################
...
INCPATH       = -I/usr/local/Cellar/qt/4.8.7_2/mkspecs/macx-g++ -I. -I/usr/local/Cellar/qt/4.8.7_2/lib/QtDesigner.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/lib/QtDesigner.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/lib/QtXml.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/lib/QtXml.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/lib/QtScript.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/lib/QtScript.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_2/include -I. -F/usr/local/Cellar/qt/4.8.7_2/lib
LINK          = g++
LFLAGS        = -headerpad_max_install_names -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.5
LIBS          = $(SUBLIBS) -F/usr/local/Cellar/qt/4.8.7_2/lib -L/usr/local/Cellar/qt/4.8.7_2/lib -framework QtScript -L/usr/local/opt/openssl/lib -L/usr/local/Cellar/qt/4.8.7_2/lib -F/usr/local/Cellar/qt/4.8.7_2/lib -framework QtCore -framework QtXml -framework QtGui -framework QtDesigner -L/private/tmp/qt20151227-9446-136qu6q/qt-everywhere-opensource-src-4.8.7/lib -F/private/tmp/qt20151227-9446-136qu6q/qt-everywhere-opensource-src-4.8.7/lib 
AR            = ar cq
RANLIB        = ranlib -s
...
DIST          = /usr/local/Cellar/qt/4.8.7_2/mkspecs/common/unix.conf \
		...
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/features/designer.prf \
...
cfgtest_QtDesigner.mk: cfgtest_QtDesigner.pro  /usr/local/Cellar/qt/4.8.7_2/mkspecs/macx-g++/qmake.conf /usr/local/Cellar/qt/4.8.7_2/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/g++-base.conf \
		...
		/usr/local/Cellar/qt/4.8.7_2/lib/QtDesigner.framework/QtDesigner.prl
	$(QMAKE) -spec /usr/local/Cellar/qt/4.8.7_2/mkspecs/macx-g++ -o cfgtest_QtDesigner.mk cfgtest_QtDesigner.pro
...
cfgtest_QtDesigner.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,cfgtest_QtDesigner,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.7_2/mkspecs/macx-g++/Info.plist.app >cfgtest_QtDesigner.app/Contents/Info.plist
dist: 
